...
if (isset($_SESSION['usertype']) && $_SESSION['usertype'] == "U_Administrador" && $_GET['edit'] == "1")
{
    ...
    $localjs = array("//cdnjs.cloudflare.com/ajax/libs/codemirror/3.20.0/codemirror.min.js", "//cdnjs.cloudflare.com/ajax/libs/codemirror/3.20.0/mode/xml/xml.min.js", "//cdnjs.cloudflare.com/ajax/libs/codemirror/2.36.0/formatting.min.js","js/summernote.min.js");
