 <form action="process/save_admin.php" method="post" enctype="multipart/form-data" onsubmit="return postForm()">
            <?php
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="eliminar" value="1"/> Delete
                    </label>
                </div>
                <?php
                }
		...
		<input type="hidden" name="bloque" value="<?php echo $bloque_select ?>" />
                ...
                <a href="<?php echo $link."?sec=".$subs_select ?>"><button type="button" class="btn btn-danger">Discard</button></a>
                <button type="submit" class="btn btn-custom" style="margin-left: 7px;">Save</button>
                </div>
                </form>