...
<div style="border: 1px solid #045d6f; border-radius:5px; height:150px; margin-bottom: 20px; width:150px; margin-left: 20px; margin-top: 20px; float:left"><img src="img/avatar/<?php echo $user['foto']?>" alt="foto" width="150" height="150" /></div>
